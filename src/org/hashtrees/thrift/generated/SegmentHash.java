 ...
 * 
 */
public class SegmentHash implements
		org.apache.thrift.TBase<SegmentHash, SegmentHash._Fields>,
	...
	private static final org.apache.thrift.protocol.TField NODE_ID_FIELD_DESC = new org.apache.thrift.protocol.TField(
			"nodeId", org.apache.thrift.protocol.TType.I32, (short) 1);
	private static final org.apache.thrift.protocol.TField HASH_FIELD_DESC = new org.apache.thrift.protocol.TField(
			"hash", org.apache.thrift.protocol.TType.STRING, (short) 2);

	private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
	static {
		schemes.put(StandardScheme.class,
				new SegmentHashStandardSchemeFactory());
	...
	public enum _Fields implements org.apache.thrift.TFieldIdEnum {
		NODE_ID((short) 1, "nodeId"), HASH((short) 2, "hash");
	...
	static {
		...
		tmpMap.put(_Fields.HASH, new org.apache.thrift.meta_data.FieldMetaData(
				"hash", org.apache.thrift.TFieldRequirementType.REQUIRED,
				new org.apache.thrift.meta_data.FieldValueMetaData(
						org.apache.thrift.protocol.TType.STRING, true)));
		metaDataMap = Collections.unmodifiableMap(tmpMap);
		org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(
				SegmentHash.class, metaDataMap);
	}

	public SegmentHash() {
	}

	public SegmentHash(int nodeId, ByteBuffer hash) {
		this();
		this.nodeId = nodeId;
		setNodeIdIsSet(true);
		this.hash = hash;
	...
	/**
	 * Returns true if field nodeId is set (has been assigned a value) and false
	 * otherwise
	 */
	...
	/**
	 * Returns true if field hash is set (has been assigned a value) and false
	 * otherwise
	 */
	...
	public int compareTo(SegmentHash other) {
		...
		lastComparison = Boolean.valueOf(isSetHash()).compareTo(
				typedOther.isSetHash());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetHash()) {
			lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.hash,
					typedOther.hash);
			if (lastComparison != 0) {
				return lastComparison;
			}
	...
	public void validate() throws org.apache.thrift.TException {
		...
		// alas, we cannot check 'nodeId' because it's a primitive and you chose
		// the non-beans generator.
		if (hash == null) {
			throw new org.apache.thrift.protocol.TProtocolException(
					"Required field 'hash' was not present! Struct: "
							+ toString());
		}
	}
	...
	private static class SegmentHashStandardSchemeFactory implements
			SchemeFactory {
	...
	private static class SegmentHashStandardScheme extends
			StandardScheme<SegmentHash> {

		public void read(org.apache.thrift.protocol.TProtocol iprot,
				SegmentHash struct) throws org.apache.thrift.TException {
			...
			if (!struct.isSetNodeId()) {
				throw new org.apache.thrift.protocol.TProtocolException(
						"Required field 'nodeId' was not found in serialized data! Struct: "
								+ toString());
			}
			struct.validate();
		}
	...
	private static class SegmentHashTupleScheme extends
			TupleScheme<SegmentHash> {
